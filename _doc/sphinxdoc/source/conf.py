...
epkg_dictionary.update({
    ...
    'C# Streaming IDataView': "https://github.com/xadupre/machinelearningext/blob/master/machinelearningext/DataManipulation/StreamingDataFrame.cs",
    ...
    'MamlHelper': 'https://github.com/xadupre/machinelearningext/blob/master/machinelearningext/DocHelperMlExt/MamlHelper.cs',
